    ...
    def post(self, request):
        ...
        try:
            ...
            system_prompt = f"""
                ...
                **작성 원칙:**
                1. **애널리스트 어조:** 보고서체가 아닌, 하지만 가볍지 않은 설명체를 사용하세요.
                ("~입니다", "~로 판단됩니다", "~가 핵심입니다")
                2. **질문 중심 답변:** 시장 전체 요약보다 **질문에서 묻는 대상과 원인**을 우선 설명하세요.
                ...
                **답변 고려 사항:**
                ### 핵심 원인
                (질문에 대한 가장 중요한 이유 1~2줄 요약)

                ### 세부 배경
                - (뉴스 근거 기반 원인 너무 길지 않게 요약하여 제시)

                ### 투자자 관점 정리
                (단기/중기 관점에서 유의할 점을 한 문장으로 정리)
